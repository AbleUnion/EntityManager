...
use milk\entitymanager\entity\Horse;
use milk\entitymanager\entity\Vex;
use milk\entitymanager\entity\Llama;
...
class EntityManager extends PluginBase implements Listener{
    ...
    public function onEnable(){
        ...
        self::$data = [
            ...
            "autospawn" => [
                "turn-on" => getData($data, "autospawn.turn-on", getData($data, "spawn.auto", false)),
